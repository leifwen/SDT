...
class CORE_AEXE : public COMMU_CORE{
	...
	private:
		...
		bool32						MonitorThreadFun	(void* _team);
	protected:
		pid_t			childpid;
...
//------------------------------------------------------------------------------------------//
typedef COMMU<TMEM|TBIRDGE,COMMU_FRAME,CORE_AEXE>	AEXE;
typedef	COMMU_POOL<COMMU<0,COMMU_FRAME,COMMU_CORE>,AEXE>	AEXEPOOL_BASE;
//------------------------------------------------------------------------------------------//
class AEXEPOOL : public AEXEPOOL_BASE{
	public:

...
static inline	_UVV_CHARS	IUD			(const char*	p)								{return{{(void*)p	,strlen(p)}		,UVID_CHARS};};
static inline	_UVV_CHARS	IUD			(const uint8&	p)								{return{{(void*)&p	,1}				,UVID_CHARS};};
static inline	_UVV_CHARS	IUD			(const uint8*	p,uint64 num)					{return{{(void*)p	,num}			,UVID_CHARS};};
#ifdef DS_ARRAY_h
static inline	_UVV_ARRAY	IUD			(const ARRAY&	p,uint32 num,uint32 offset)		{return{{(void*)&p	,num	,offset},UVID_ARRAY};};
static inline	_UVV_ARRAY	IUD			(const ARRAY*	p,uint32 num,uint32 offset)		{return{{(void*)p	,num	,offset},UVID_ARRAY};};
#endif
static inline	_UVV_FILE	IUD_FILE	(const STDSTR&	name,uint64 num,uint64 offset)	{return{{(void*)&name,num	,offset},UVID_FILE};};
//------------------------------------------------------------------------------------------//
...
#ifdef DS_ARRAY_h
inline UVOut::UVOut(const ARRAY* uv)							{uvid = UVID_ARRAY;	uvp = (void*)uv;};
#endif
...
#ifdef DS_ARRAY_h
inline const UVOut& UVOut::operator = (const ARRAY* uv)			{uvid = UVID_ARRAY;	uvp = (void*)uv;		return(*this);};
#endif
//------------------------------------------------------------------------------------------//
...
//------------------------------------------------------------------------------------------//
inline UVIn::UVIn(void)					{uvid = UVID_NONE;	uvp = nullptr;};
inline UVIn::UVIn(const UVIn&		uv)	{uvid = uv.uvid;	uvp = uv.uvp;};
inline UVIn::UVIn(const _UVBASE&	uv)	{uvid = uv.uvid;	uvp = (void*)uv.p;};
inline UVIn::UVIn(const STDSTR&		uv)	{uvid = UVID_STR;	uvp = (void*)&uv;};
inline UVIn::UVIn(const STDSTR*		uv)	{uvid = UVID_STR;	uvp = (void*)uv;};
//------------------------------------------------------------------------------------------//
...
//------------------------------------------------------------------------------------------//
inline const UVIn& UVIn::operator = (const UVIn&		uv)		{uvid = uv.uvid;	uvp = (void*)uv.uvp;	return(*this);};
inline const UVIn& UVIn::operator = (const _UVBASE&		uv)		{uvid = uv.uvid;	uvp = (void*)uv.p;		return(*this);};
//------------------------------------------------------------------------------------------//

...
class CORE_SOCKETSERVER : public COMMU_CORE{
	...
	private:
				bool32	ListionThreadFunc	(void* _team);
		...
		virtual bool32	OnOpenUDPSocket		(COMMU_DRV* newSocket);
};
//------------------------------------------------------------------------------------------//
typedef COMMU_DRV_T<TDEFALL,COMMU_DRV,CORE_SOCKET>										ASOCKET;
typedef	CDRV_POOL_T<COMMU_DRV_T<TODEVBUS|TDISPOSE,COMMU_DRV,CORE_SOCKETSERVER>,ASOCKET>	ASOCKETSERVER;
//------------------------------------------------------------------------------------------//

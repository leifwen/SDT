...
typedef COMMU_DRV_T<TMEM|TBIRDGE,COMMU_DRV_NOSMC,CORE_SOCKET,MEM_MSG<MSG_Rerister>>	LicSocket;
typedef	CDRV_POOL_T<COMMU_DRV_T<0,COMMU_DRV_NOSMC,CORE_SOCKETSERVER>,LicSocket>		LicServer_BASE;
class LicServer : public LicServer_BASE{
	...
	private:
		...
		COMMU_DRV*			cgRequestSocket;
		uint32*				cgApproveHours;
	public:
				bool32	CheckblRequest		(void)const;
				bool32	CheckApprove		(COMMU_DRV* tSocket,uint32* retHours);

...
//------------------------------------------------------------------------------------------//
enum{
	COMENUM_DEVID_NONE		= (0x00),
	COMENUM_DEVID_APICOM	= (0x04),
	COMENUM_DEVID_TCPClient	= (0x07),
	COMENUM_DEVID_UDPClient	= (0x08),
	COMENUM_DEVID_TCPServer	= (0x09),
	COMENUM_DEVID_UDPServer	= (0x0A),
};
//------------------------------------------------------------------------------------------//
class PORTINFO{
	public:

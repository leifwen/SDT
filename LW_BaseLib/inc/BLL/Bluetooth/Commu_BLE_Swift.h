...
extern "C" int		Swift_BLE_GetMTU_NR(const char* identifier,const char* service,const char* characteristic);
...
extern "C" int		Swift_BLE_WriteNR(const char* identifier,const char* service,const char* characteristic,const char* buffer,int len);

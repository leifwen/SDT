...
#endif
//------------------------------------------------------------------------------------------//
typedef bool32(*ThreadFunc) (void *);
...
#endif
	public:
				void	ThreadRun		(ThreadFunc _func,void* exep = nullptr);
...
class SYS_Thread_List : public TNF{
	...
	public:
		...
		void			Enable		(const STDSTR& name);
		void			Disable		(const STDSTR& name);
		void			EnableAll	(void);

...
void CCMUXCOMCtrl::OnOpen(void){
	...
	if (m_blConnect == FALSE){
		m_CMUXCOM = GSDTApp.m_CMUXDriver.VCOMOpen(m_ComNumber,m_ValidAuxComList.selectedNode->strIPComName,m_ValidAuxComList.selectedNode->portBaudrate);
		if (m_CMUXCOM != NULL){
			m_blConnect = TRUE;

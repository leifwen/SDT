...
END_MESSAGE_MAP()
//------------------------------------------------------------------------------------------//
CMyRichView::CMyRichView(void) : CRichEditView(){
...
//------------------------------------------------------------------------------------------//
void	CMyRichView::Spin_Print_Lock	(G_LOCK blVaild){cgPrintLock.Lock(blVaild);};
void	CMyRichView::Spin_Print_Unlock	(G_LOCK blVaild){cgPrintLock.Unlock(blVaild);};
bool32	CMyRichView::Spin_Print_Try		(G_LOCK blVaild){return(cgPrintLock.TryLock(blVaild));};
//------------------------------------------------------------------------------------------//
...
//------------------------------------------------------------------------------------------//
void CMyRichView::SaveToRtfFile(std::string& filename){
	CFile cFile;
	EDITSTREAM es;
	cFile.Open(Str_ANSIToUnicode(filename).c_str(),CFile::modeCreate|CFile::modeWrite);
...
//------------------------------------------------------------------------------------------//
void CMyRichView::PrintRtfFile(std::string& filename){
	...
	CFile cFile;
	EDITSTREAM es;
	cFile.Open(Str_ANSIToUnicode(filename).c_str(),CFile::modeRead);
	es.dwCookie = (DWORD) &cFile;
...
//------------------------------------------------------------------------------------------//
void CMyRichView::PrintTxtFile(std::string& filename){
	if (CFS_CheckFile(filename) == 0)
		return;
	Clean();
...
//------------------------------------------------------------------------------------------//
void CMyRichView::PrintHexFile(std::string& filename){
	if (CFS_CheckFile(filename) == 0)
		return;
	Clean();

...
#define		SWVERSION_VER			"V0.7.6"
#define		SWVERSION_WR			"Written by Leif Wen"

#ifdef CommonDefH_MAC
#define		SWVERSION_APPID			"LeifWen.SDT.MAC.V0.7.0"
#define		SWVERSION_NAME			"Script Debugging Tools(MAC Version)"
#define		SWVERSION				"Script Debugging Tools(MAC Version) V0.7.6, Written by Leif Wen"
#define		CMUX_COM_NAME			"/dev/ttySDTMUX"
#endif
#ifdef CommonDefH_Linux
#define		SWVERSION_APPID			"LeifWen.SDT.Linux.V0.7.0"
#define		SWVERSION_NAME			"Script Debugging Tools(Linux Version)"
#define		SWVERSION				"Script Debugging Tools(Linux Version) V0.7.6, Written by Leif Wen"
#define		CMUX_COM_NAME			"/dev/ttySDTMUX"
...
#define		SWVERSION_APPID			"LeifWen.SDT.MFC.V0.7.0"
#define		SWVERSION_NAME			"Script Debugging Tools(VC2013 MFC Version)"
#define		SWVERSION				"SDT(VC2013 MFC Version) V0.7.6, Written by Leif Wen"

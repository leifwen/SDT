...
#define		SWVERSION				"Script Debugging Tools(MAC Version) V0.6.2, Written by Leif Wen"
...
#define		SWVERSION				"Script Debugging Tools(Linux Version) V0.6.2, Written by Leif Wen"
#define		CMUX_COM_NAME			"/dev/ttySDTMUX"
...
#define		SWVERSION				"SDT(VC2013 MFC Version) V0.6.2, Written by Leif Wen"
